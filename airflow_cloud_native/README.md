...
See **[CHEATSHEET.md](./CHEATSHEET.md)** for a quick reference covering the data model, processes, executors, scheduling/triggering, Assets, trigger rules, task context, the 2.x→3.x changes, and pitfalls we hit while building this lab.
